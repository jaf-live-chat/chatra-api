...
import { allowInactiveSubscriptionReadOnly } from "../../middlewares/subscriptionAccessMiddleware.js";
import {
  acceptConversation,
  assignConversation,
  endConversation,
...
router.get("/conversations/history", allowInactiveSubscriptionReadOnly, tenantAuth, protect, liveChatStaffAuth, getConversationHistory);
router.get("/analytics/summary", tenantAuth, protect, liveChatStaffAuth, getAnalyticsSummary);
router.get("/visitors", allowInactiveSubscriptionReadOnly, tenantAuth, protect, liveChatStaffAuth, getVisitorsValidator, getVisitors);
router.get("/visitors/:id", allowInactiveSubscriptionReadOnly, tenantAuth, protect, liveChatStaffAuth, getVisitorByIdValidator, getVisitorById);
...
router.get("/messages/:conversationId", allowInactiveSubscriptionReadOnly, tenantAuth, protect, liveChatStaffAuth, getMessagesByConversationId);
